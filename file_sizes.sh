...
find ./public/ -name "*.jpg" -type f -size +300k -exec exit 1 \;
find ./public/ -name "*.JPG" -type f -size +300k -exec exit 1 \;
find ./public/ -name "*.jpeg" -type f -size +300k -exec exit 1 \;
find ./public/ -name "*.JPEG" -type f -size +300k -exec exit 1 \;
find ./public/ -name "*.png" -type f -size +300k -exec exit 1 \;
find ./public/ -name "*.PNG" -type f -size +300k -exec exit 1 \;
find ./public/ -name "*.gif" -type f -size +300k -exec exit 1 \;
find ./public/ -name "*.GIF" -type f -size +300k -exec exit 1 \;
